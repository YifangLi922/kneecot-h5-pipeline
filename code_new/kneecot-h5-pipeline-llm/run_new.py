...
now a separate, shared step (see code_new/analysis/compare_new.py and
judge_new.py) so that the LLM and VLM lines are always judged by the same
...
from evaluation_new import save_json
...
def main():
    ...
    print(
        ...
        "  yes/no   -> python code_new/analysis/compare_new.py ...\n"
        "  inference -> python judge_new.py --input {} ...\n".format(out_path)
    )
